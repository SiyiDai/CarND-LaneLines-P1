...
As follow is a [lane detection tool](), the first project of the [Self Driving Car Nano Degree](https://www.udacity.com/drive) program through Udacity.
The goal of the project was to detect lane lines on overhead camera images and video footages taken while driving.
...
In this post, the logic behind the pipeline will be illustrate by steps.
